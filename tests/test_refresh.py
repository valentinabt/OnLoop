...
@patch("backend.routers.auth.get_refresh_token_from_session", return_value=None)
...
@patch("backend.routers.auth.refresh_access_token", return_value=("access_token",None))
@patch("backend.routers.auth.get_refresh_token_from_session", return_value="refresh_token")
...
@patch("backend.routers.auth.refresh_access_token", return_value=(None,"new_refresh_token"))
@patch("backend.routers.auth.get_refresh_token_from_session", return_value="refresh_token")
...
@patch("backend.routers.auth.refresh_access_token", return_value=(None, None))
@patch("backend.routers.auth.get_refresh_token_from_session", return_value="refresh_token")
...
@patch("backend.routers.auth.update_session", return_value=None)
@patch("backend.routers.auth.refresh_access_token", return_value=("access_token","new_refresh_token"))
@patch("backend.routers.auth.get_refresh_token_from_session", return_value="refresh_token")
...
@patch("backend.routers.auth.update_session", return_value="abc")
@patch("backend.routers.auth.refresh_access_token", return_value=("access_token", "new_refresh_token"))
@patch("backend.routers.auth.get_refresh_token_from_session", return_value="refresh_token")
