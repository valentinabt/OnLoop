...
@patch("backend.routers.api.get_access_token_from_session", return_value=None)
...
@patch("backend.routers.api.get_artists", return_value=None)
@patch("backend.routers.api.get_access_token_from_session", return_value="access_token")
...
@patch("backend.routers.api.get_artists", return_value=[{"name": "Artist1"}])
@patch("backend.routers.api.get_access_token_from_session", return_value="access_token")
